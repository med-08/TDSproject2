...
# Send a HTTPS request to https: // httpbin.org/get with the URL encoded parameter email set to 22f3002491@ds.study.iitm.ac. in
...
# (It won't work in Excel)= SUM(ARRAY_CONSTRAIN(SEQUENCE(100, 100, 11, 8), 1, 10))
#     What is the result?
...
# =SUM(TAKE(SORTBY({12,2,5,5,6,8,0,14,0,9,8,10,2,3,9,15}, {10,9,13,2,11,8,16,14,7,15,5,4,6,1,3,12}), 1, 16))
# What is the result?
...
# How many Wednesdays are there in the date range 1988-03-31 to 2007-12-16?
...
# [{"name":"Alice","age":14},{"name":"Bob","age":72},{"name":"Charlie","age":69},{"name":"David","age":54},{"name":"Emma","age":62},{"name":"Frank","age":83},{"name":"Grace","age":27},{"name":"Henry","age":67},{"name":"Ivy","age":78},{"name":"Jack","age":73},{"name":"Karen","age":85},{"name":"Liam","age":80},{"name":"Mary","age":85},{"name":"Nora","age":84},{"name":"Oscar","age":41},{"name":"Paul","age":2}]
# Sorted JSON:
...
# Each file has 2 columns: symbol and value. Sum up all the values where the symbol matches ž OR ™ OR – across all three files.
...
# Let's make sure you know how to use GitHub. Create a GitHub account if you don't have one. Create a new public repository. Commit a single JSON file called email.json with the value {"email": "22f3002491@ds.study.iitm.ac.in"} and push it.
...
# What's the total size of all files at least 7722 bytes large and modified on or after Mon, 26 May, 1997, 12:00 pm IST?
